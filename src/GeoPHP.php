...
class GeoPHP
{
    ...
    // It could make a mistake in XML detection if you are mixing or using
    // namespaces in weird ways (ie, KML inside an RSS feed)
    public static function detectFormat(&$input)
    {
        ...
        // Detect geohash - geohash ONLY contains lowercase chars and nummerics
